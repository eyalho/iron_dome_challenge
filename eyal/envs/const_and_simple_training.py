...
class Rocket():
    def __init__(self, world):
        ...
        self.v0 = 700 + 0.2 * 300  # [m/sec] ##### CHANGED #####
        self.ang = -88 + 0.7 * 68  # [deg] ##### CHANGED #####
...
def Draw():
    ...
    plt.title(f'Score: {world.score}, step={int(5*world.time)} len(rocket_list)={len(rocket_list)}')
    plt.draw()
    plt.pause(0.0001)
