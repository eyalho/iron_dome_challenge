...
class CnnAgent(ABSDQNAgent):
    ...
    def _build_model(self):
        ...
        input_shape = (self.py, self.px,self.frame_history)
        ...
        mid_layer_1 = concatenate([dense_output, input_ang])
        mid_layer_2 = Dense(128, activation='linear')(mid_layer_1)
        out_layer = Dense(self.action_size, activation='linear')(mid_layer_2)
        model = Model(
