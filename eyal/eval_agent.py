...
model_path = './models/DQN CNN 42x84x8_e6600_2020_02_20-10_56_16.hdf5'
"""
class test_agent()
...
def create_agent(path):
    agent = DQNAgent()
    agent.model.load_weights('./models/model_full_state_e12650_2020_02_19-06_54_44.hdf5')
...
print('test ended with score of:' + str(scores[len(scores)-1]))
